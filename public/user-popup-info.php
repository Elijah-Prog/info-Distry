...
<html>
    ...
    <body>
        ...
        <div class="gb_9a">
            <div class="gb_ab">
                <img draggable=false class="gb_Ha" src="<?php echo $user_data['profile_image']?>" title="Profile" alt="" aria-hidden="true">
        </div>
        <div class="gb_bb">
            <div class="gb_lb gb_mb"><?php echo $user_data['first_name'] . " " . $user_data['last_name']?></div>
            <div class="gb_nb"><?php echo $user_data['email']?></div>
            <a class="gb_rb gb_Mf gbp1 gb_Je gb_3c" title="Edit Your Account" href="user-profile.php?url_address=<?php echo $user_data['url_address']?>">Manage your Account</a>
        </div>
        </div>
        <div class="gb_Eb gb_Ib">
            <div class="gb_jf"><a class="gb_Cb" href="index.php">Timeline</a></div>
        <div class="gb_7b">
        </div>
        </div>
        ...
        <div class="gb_Jf gb_Bb">
            <a class="gb_Cb gb_Nf gb_Vf gb_Je gb_3c" id="gb_71" href="logout.php">Sign out</a>
        </div>
